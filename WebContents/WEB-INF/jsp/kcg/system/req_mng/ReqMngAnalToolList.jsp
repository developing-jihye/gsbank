...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>분석도구 신청관리</strong></li>
		</ol>
			...
			<table class="table table-bordered datatable dataTable" id="grid_app">
				<thead>
					<tr class="replace-inputs">
						...
						<th style="width: 21%;" class="center sorting" @click="sortList(event.target)" sort_target="anal_tool_gbn_nm">분석도구</th>
				...
				<tbody id="tbody_list">
					...
					<tr v-for="item in dataList">
						...
						<td class="center" @click="gotoDtl(item.idx)" style="cursor: pointer;">{{item.anal_tool_gbn_nm}}</td>
...
var vueapp = new Vue({
	...
	methods : {
		getList : function(isInit){
			...
			cf_ajax("/system/req_mng/analTool/getList", params, this.getListCB);
		},
		...
		gotoDtl : function(idx){
			...
			cf_movePage("/system/req_mng/analTool/dtl", params);
		},
		...
		changeSts : function(){
			...
			cf_ajax("/system/req_mng/analTool/updtStatus", params, this.changeStsCB);
		},

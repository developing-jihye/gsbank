...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>데이터 분석신청관리</strong></li>
		</ol>
	
		<h2>데이터 분석신청관리 > 상세보기</h2>
		<br />
			...
			<template>
				<div class="panel panel-primary" data-collapsed="0">
					...
					<form class="form-horizontal form-groups-bordered">
						...
						<div class="form-group">
							<label for="req_dept_nm" class="sys_label_01 control-label">요청부서</label>
							<div class="sys_col_02">
								<input type="text" class="form-control" id="req_dept_nm" v-model="info.req_dept_nm" readonly="readonly">
							</div>
						...
						<div class="form-group">
							<label for="req_dtl_ctnt" class="sys_label_01 control-label">요청 상세내용</label>
...
var vueapp = new Vue({
	...
	methods : {
		getInfo : function(){
			cf_ajax("/system/req_mng/dataAnal/getInfo", this.info, this.getInfoCB);
		},
		...
		save : function(){
			...
			cf_ajax("/system/req_mng/dataAnal/save", this.info, this.saveCB);
		},
		...
		delInfo : function(){
			...
			cf_ajax("/system/req_mng/dataAnal/delete", this.info, this.delInfoCB);
		},
		delInfoCB : function(data){
			this.gotoList();
		},
		gotoList : function(){
			cf_movePage('/system/req_mng/dataAnal/list?fromDtl=Y');
		},
	}
});
</script>

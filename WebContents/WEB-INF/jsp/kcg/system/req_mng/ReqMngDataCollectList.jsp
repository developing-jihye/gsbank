...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>데이터수집 신청관리</strong></li>
		</ol>
		...
		<template>
			...
			<div class="dataTables_filter">
				<select v-model="search_nm">
					<option value="req_resn">데이터 요청사유</option>
			...
			<table class="table table-bordered datatable dataTable">
				<thead>
					<tr class="replace-inputs">
						...
						<th style="width: 21%;" class="center sorting" @click="sortList(event.target)" sort_target="req_resn">데이터 요청사유</th>
				...
				<tbody>
					<tr v-for="item in dataList">
						...
						<td class="center" @click="gotoDtl(item.idx)" style="cursor: pointer;">{{item.req_resn}}</td>
...
var vueapp = new Vue({
	...
	methods : {
		getList : function(isInit){
			...
			cf_ajax("/system/req_mng/dataCollect/getList", params, this.getListCB);
		},
		...
		gotoDtl : function(idx){
			...
			cf_movePage("/system/req_mng/dataCollect/dtl", params);
		},
		...
		changeSts : function(){
			...
			cf_ajax("/system/req_mng/dataCollect/updtStatus", params, this.changeStsCB);
		},

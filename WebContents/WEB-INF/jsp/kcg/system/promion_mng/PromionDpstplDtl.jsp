				...
				<div class="right flex-column flex-100">
                    <div class="right-top">
					    ...
					    <div class="nav-content flex-column flex-gap-10">
					        ...
					        <div class="form-group flex-row align-items-center" style="height: 40px;">
					            <label style="flex: 0 0 120px; margin-right: 10px; line-height: 40px;">예치금액 (원):</label>
					            <input class="form-control flex-50" type="text" id="dpst_amt" v-model="info.dpst_amt" style="height: 100%; width: 700px;"/>
					        ...
					        <div class="form-group flex-row align-items-center" style="height: 40px;">
					            ...
					            <input class="form-control flex-50" type="text" id="dpst_prd" v-model="info.dpst_prd" style="height: 100%; width: 700px;"/>

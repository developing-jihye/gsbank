							...
							<div class="left-panel" style="width: 50%;">
								<div class="form-group">
									<label for="err_eng_nm" class="fix-width-33">작성일자:</label> <input
										type="text" class="form-control" id="wrt_dt"
										v-model="info.wrt_dt">
								</div>

								<div class="form-group">
									<label for="err_eng_nm" class="fix-width-33">성명:</label> <input
										type="text" class="form-control" id="cust_nm"
										v-model="info.cust_nm">
								</div>


								<div class="form-group">
									<label for="err_eng_nm" class="fix-width-33">실명번호:</label> <input
										type="text" class="form-control" id="rrno" v-model="info.rrno">
								</div>


								<div class="form-group">
									<label for="err_eng_nm" class="fix-width-33">E-mail:</label> <input
								...
								<div class="form-group">
									<label for="err_eng_nm" class="fix-width-33">직업:</label> <input
										type="text" class="form-control" id="occp_ty_cd_nm"
										v-model="info.occp_ty_cd_nm">
								</div>

								<div class="form-group">
									<label for="err_eng_nm" class="fix-width-33">주소:</label> <input
										type="text" class="form-control" id="cust_addr"
										v-model="info.cust_addr">
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal form-groups-bordered">
							<div>
								[고객이벤트목록] 를(을) 출력하시겠습니까?<br> ※고객정보는 개인정보관리 대상이므로 유의하셔야 합니다.
							</div>
							<div class="form-group">
				...
				methods : {
					...
					print : function() {
						const printArea = document
								.getElementById('cust_mnglist_printArea').innerHTML;

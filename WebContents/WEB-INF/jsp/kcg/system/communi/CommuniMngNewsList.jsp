...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>새소식 공유</strong></li>
		</ol>
	
		<h2>새소식 공유 목록</h2>
		<blockquote>
		  <p>통합 Data-Hub의 새 소식입니다.</p>
...
var vueapp = new Vue({
	...
	methods : {
		getList : function(isInit){
			...
			cf_ajax("/system/communi_mng/news/getList", params, this.getListCB);
		},
		...
		gotoDtl : function(idx){
			...
			cf_movePage("/system/communi_mng/news/dtl", params);
		},

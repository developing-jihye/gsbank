...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>자료실</strong></li>
		</ol>
...
var vueapp = new Vue({
	...
	methods : {
		getInfo : function(){
			cf_ajax("/system/communi_mng/library/getInfo", this.info, this.getInfoCB);
		},
		...
		save : function(){
			...
			cf_ajaxWithFiles("/system/communi_mng/library/save", fileList, this.info, this.saveCB);
		},
		...
		delInfo : function(){
			...
			cf_ajax("/system/communi_mng/library/delete", this.info, this.delInfoCB);
		},
		delInfoCB : function(data){
			this.gotoList();
		},
		gotoList : function(){
			cf_movePage('/system/communi_mng/library/list?fromDtl=Y');
		},
	}
});
</script>

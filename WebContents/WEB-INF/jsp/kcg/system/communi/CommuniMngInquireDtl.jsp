					...
					<form class="form-horizontal form-groups-bordered">
						...
						<div class="form-group" v-if="info.idx != ''">
							...
							<div class="sys_col_02">
								<input type="text" class="form-control" id="reg_user_name" v-model="info.reg_user_name" readonly>
							</div>
						...
						<div class="form-group" v-if="info.idx != ''">
							<label for="ask_sts_nm" class="sys_label_01 control-label">진행상태</label>
							<div class="sys_col_01">
								<input type="text" class="form-control" id="ask_sts_nm" v-model="info.ask_sts_nm" readonly>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="sys_col_03">
								<input type="text" class="form-control" id="sbjt" v-model="info.sbjt" readonly>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="sys_col_05">
								<textarea class="form-control" rows="5" id="ctnt" placeholder="내용을 입력하세요." readonly></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="repl" class="sys_label_01 control-label">답변</label>
							<div class="sys_col_05">
								<textarea class="form-control" rows="5" id="repl" placeholder="내용을 입력하세요." v-model="info.repl"></textarea>
							</div>
						</div>
...
var vueapp = new Vue({
	...
	methods : {
		getInfo : function(){
			cf_ajax("/system/communi_mng/inquire/getInfo", this.info, this.getInfoCB);
		},
		...
		save : function(){
			...
			cf_ajaxWithFiles("/system/communi_mng/inquire/save", fileList, this.info, this.saveCB);
		},
		...
		delInfo : function(){
			...
			cf_ajax("/system/communi_mng/inquire/delete", this.info, this.delInfoCB);
		},
		delInfoCB : function(data){
			this.gotoList();
		},
		gotoList : function(){
			cf_movePage('/system/communi_mng/inquire/list?fromDtl=Y');
		},
	}
});
</script>

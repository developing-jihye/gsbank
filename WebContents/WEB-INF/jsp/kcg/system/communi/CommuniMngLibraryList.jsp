...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>자료실 공유</strong></li>
		</ol>
	
		<h2>자료실 공유 목록</h2>
		<blockquote>
		  <p>통합 Data-Hub에서 공유하는 자료실입니다.</p>
		</blockquote>
		<br/>
				...
				<table class="table table-bordered datatable dataTable" id="grid_app">
					<thead>
						<tr class="replace-inputs">
							...
							<th style="width: 55%;" class="center sorting" @click="sortList(event.target)" sort_target="sbjt">제목</th>
							...
							<th style="width: 10%;" class="center sorting" @click="sortList(event.target)" sort_target="reg_dt">작성일</th>
...
var vueapp = new Vue({
	...
	methods : {
		getList : function(isInit){
			...
			cf_ajax("/system/communi_mng/library/getList", params, this.getListCB);
		},
		...
		gotoDtl : function(idx){
			...
			cf_movePage("/system/communi_mng/library/dtl", params);
		},

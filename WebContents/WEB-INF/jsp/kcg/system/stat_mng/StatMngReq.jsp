...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>신청 현황</strong></li>
		</ol>
			...
			<div class="row">
				<div style="width: 910px; margin-left: 15px;">
					<div class="panel panel-primary">
						...
						<form class="form-horizontal form-groups-bordered">
							<div class="form-group">
								<label class="control-label" style="width: 200px;float: left;">데이터 수집 신청</label>
								<div style="width: 350px;float: left; margin-left: 30px;">
									<input type="text" value="374" class="form-control" v-model="req_data_collect_cnt" readonly />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label" style="width: 200px;float: left;">데이터 분석 신청</label>
								<div style="width: 350px;float: left; margin-left: 30px;">
									<input type="text" value="374" class="form-control" v-model="req_data_anal_cnt" readonly />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label" style="width: 200px;float: left;">도구 사용 신청</label>
								<div style="width: 350px;float: left; margin-left: 30px;">
									<input type="text" value="374" class="form-control" v-model="req_anal_tool_cnt" readonly />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label" style="width: 200px;float: left;">다운로드 신청</label>
								<div style="width: 350px;float: left; margin-left: 30px;">
									<input type="text" value="374" class="form-control" v-model="req_dnld_cnt" readonly />
								</div>
							</div>
						</form>
						</div>
...
var vueapp = new Vue({
	...
	methods : {
		...
		getData : function(){
			...
			cf_ajax("/system/stat_mng/req/getData", params, this.getDataCB);
		},
		getDataCB : function(data){
			$("#fromdatespan").text(this.from_date);
			$("#todatespan").text(this.to_date);
			this.req_anal_tool_cnt = data.req_anal_tool_cnt;
			this.req_data_anal_cnt = data.req_data_anal_cnt;
			this.req_data_collect_cnt = data.req_data_collect_cnt;
			this.req_dnld_cnt = data.req_dnld_cnt;
		},
	}
});
</script>

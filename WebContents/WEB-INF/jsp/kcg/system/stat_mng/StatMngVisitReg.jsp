...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>방문/가입 현황</strong></li>
		</ol>
			...
			<div class="row">
				<div style="width: 910px; margin-left: 15px;">
					<div class="panel panel-primary">
						...
						<form class="form-horizontal form-groups-bordered">
							<div class="form-group">
								<label class="control-label" style="width: 100px;float: left;">방문 수</label>
								<div style="width: 150px;float: left; margin-left: 30px;">
									<input type="text" value="374" class="form-control" v-model="visit_cnt" readonly />
								</div>
								<label class="control-label" style="width: 100px;float: left;">가입 수</label>
								<div style="width: 150px;float: left; margin-left: 30px;">
									<input type="text" value="36665" class="form-control" v-model="reg_cnt" readonly />
								</div>
							</div>
						</form>
						</div>
...
var vueapp = new Vue({
	...
	methods : {
		...
		getData : function(){
			...
			cf_ajax("/system/stat_mng/visitReg/getData", params, this.getDataCB);
		},
		getDataCB : function(data){
			$("#fromdatespan").text(this.from_date);
			$("#todatespan").text(this.to_date);
			this.visit_cnt = data.visit_cnt;

...
<div class="page-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb bc-3">
			...
			<li class="active"><strong>활용사례</strong></li>
		</ol>
			...
			<table class="table table-bordered datatable dataTable" id="grid_app">
				<thead>
					<tr class="replace-inputs">
						<th style="width: 10%;" class="center nosort">No.</th>
						<th style="width: 50%;" class="center sorting" @click="sortList(event.target)" sort_target="sbjt">제목</th>
						<th style="width: 15%;" class="center sorting" @click="sortList(event.target)" sort_target="reg_user_name">작성자</th>
				...
				<tbody>
					<tr v-for="item in dataList">
						...
						<td class="center" @click="gotoDtl(item.idx)" style="cursor: pointer;">{{item.read_cnt}}</td>
					</tr>
				</tbody>
			</table>
...
var vueapp = new Vue({
	...
	methods : {
		getList : function(isInit){
			...
			cf_ajax("/system/share_mng/useExample/getList", params, this.getListCB);
		},
		...
		gotoDtl : function(idx){
			...
			cf_movePage("/system/share_mng/useExample/dtl", params);
		},

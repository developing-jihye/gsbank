...
<!-- 				</button> -->
			...
			<div class="dataTables_filter">
				<select id="search_nm" v-model="search_nm">
					<option value="auth_nm">어드민계정명</option>
				</select>	
			...
			<table class="table table-bordered datatable dataTable" id="grid_app">
				<thead>
					<tr class="replace-inputs">
						...
						<th style="width: 95%;" class="center sorting" @click="sortList(event.target)" sort_target="auth_nm">어드민계정명</th>
					</tr>
				</thead>
				<tbody id="tbody_list">
					<tr v-for="item in dataList"  @click="gotoDtl(item.auth_nm)" style="cursor: pointer;">
...
var vueapp = new Vue({
	...
	methods : {
		getList : function(isInit){
			...
			cf_ajax("/system/admin_auth_mng/getList", params, this.getListCB);
		},
		getListCB : function(data){			
			this.dataList = data.list;
			cv_pagingConfig.renderPagenation("system");
		},
		gotoDtl : function(auth_nm){
			var params = {
					auth_nm : cf_defaultIfEmpty(auth_nm, ""),
				}
			cf_movePage("/system/admin_auth_mng/dtl", params);
		},

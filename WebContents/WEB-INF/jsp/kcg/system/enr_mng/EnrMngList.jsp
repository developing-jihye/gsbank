				...
				<div class="left">
					<div class="form-group2">
						...
						<div class="input-container">
							<input id="customerInput" type="text" v-model="selectedCustomer"
								class="form-control" placeholder="고객 전화번호를 입력하세요">
						</div>

					</div>
					<div class="form-group2">
						<label for="prodCode" class="form-control">상품:</label> <input
							id="productInput" type="text" v-model="selectedProduct"
							class="form-control" placeholder="상품 코드를 입력하세요">
					...
					<!-- <label for="prodCode" class="form-control">선택해서 가입하기</label> <select
						v-model="selectedCustomer1" class="form-control"> -->
					...
					<select v-model="selectedProduct1" class="form-control">
						...
						<option value="0">전체</option>
						<option v-for="product in uniqueProducts" :value="product">{{
							product }}</option>
					</select> -->

...
//
	 ...
	 * @return 암호화된 문자열
	 */
	public static String encryptAES256(String message, String privateKey) {
		try {
	 ...
	 * @return 복호화된 문자열
	 */
	public static String decryptAES256(String message, String privateKey) {
		try {
			String iv = privateKey.substring(0, 16);
			byte[] keyBytes = new byte[16];
			byte[] b = privateKey.getBytes("UTF-8");

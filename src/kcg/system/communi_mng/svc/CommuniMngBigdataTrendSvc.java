...
@Service
public class CommuniMngBigdataTrendSvc {
	...
	* */	
	public PageList<CmmnMap> getList(CmmnMap params, PagingConfig pagingConfig) {
		PageList<CmmnMap> rslt = cmmnDao.selectListPage("communi.mng.bigdata.trend.getList", params, pagingConfig);
		return rslt;
	}
	...
	* */	
	public CmmnMap getInfo(CmmnMap params) {
		...
		CmmnMap info = cmmnDao.selectOne("communi.mng.bigdata.trend.getInfo", params);
		if(info != null) {
	...
	* */	
	public CmmnMap save(MultipartFileList fileList,CmmnMap params) {
		...
		String uploadRelativePath = StringUtil.join("/communiBigdataTrend/", CmmnUtil.getTodayString().substring(0,6), '/');
		...
		if("insert".equals(save_mode)) {
			...
			cmmnDao.insert("communi.mng.bigdata.trend.insertInfo", params);
		} else {
			cmmnDao.update("communi.mng.bigdata.trend.updateInfo", params);
		}
	...
	* */	
	public void delete(CmmnMap params) {
		cmmnDao.delete("communi.mng.bigdata.trend.deleteInfo", params);
	}
}

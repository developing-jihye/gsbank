...
@Service
public class CommuniMngNewsSvc {
	...
	* */	
	public PageList<CmmnMap> getList(CmmnMap params, PagingConfig pagingConfig) {
		PageList<CmmnMap> rslt = cmmnDao.selectListPage("communi.mng.news.getList", params, pagingConfig);
		return rslt;
	}
	...
	* */	
	public CmmnMap getInfo(CmmnMap params) {
		CmmnMap info = cmmnDao.selectOne("communi.mng.news.getInfo", params);
		if(info != null) {
	...
	* */	
	public CmmnMap save(MultipartFileList fileList,CmmnMap params) {
		...
		String uploadRelativePath = StringUtil.join("/communiNews/", CmmnUtil.getTodayString().substring(0,6), '/');
		...
		if("insert".equals(save_mode)) {
			...
			cmmnDao.insert("communi.mng.news.insertInfo", params);
		} else {
			cmmnDao.update("communi.mng.news.updateInfo", params);
		}
	...
	* */	
	public void delete(CmmnMap params) {
		cmmnDao.delete("communi.mng.news.deleteInfo", params);
	}

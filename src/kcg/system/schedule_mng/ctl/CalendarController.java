...
public class CalendarController {
	...
	public CmmnMap getAllEvents(HttpServletRequest request, HttpServletResponse response) {
		...
		String jikgubCd = (String) session.getAttribute("jikgubCd");
		logger.info("Retrieved userId from session: {}", userId);
		logger.info("Retrieved userId from 직업: {}", jikgubCd);

		// 서비스 메서드 호출
		List<CmmnMap> events = calendarService.getAllEvents(userId, jikgubCd);
